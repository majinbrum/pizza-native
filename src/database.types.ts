// npx supabase login
// npx supabase gen types typescript --project-id INSERT_project_reference_id > src/database.types.ts
// to auto generate from supabase the types to use them in the lib/supabase.ts
